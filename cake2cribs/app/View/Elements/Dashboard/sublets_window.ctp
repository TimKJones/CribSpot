<div id="sublet_window" class="container-fluid">
	...
	<div class="row-fluid">
		...
		<div class="span4">
			...
			<div class="btn-group sublet_fields" data-toggle="buttons-radio" data-field-name="beds">
				<button type="button" class="btn btn-primary" value="0">Studio</button>
		...
		<div class="span8">
			...
			<div class="btn-group pull-left sublet_fields" data-toggle="buttons-radio" data-field-name="baths">
				<button type="button" class="btn btn-primary" value="0.5">0.5</button>
				<button type="button" class="btn btn-primary" value="1">1</button>
				<button type="button" class="btn btn-primary" value="1.5">1.5</button>
				<button type="button" class="btn btn-primary" value="2">2</button>
				<button type="button" class="btn btn-primary" value="2.5">2.5</button>
				<button type="button" class="btn btn-primary" value="3">3</button>
			</div>
			<!-- PRIVATE/SHARED BATHROOM -->
			<div class="btn-group sublet_fields" data-toggle="buttons-radio" data-field-name="bathroom_type">
				<button type="button" class="btn btn-primary" value="1">Shared</button>
				<button type="button" class="btn btn-primary" value="0">Private</button>
			</div>
		</div>
	</div>
	...
	<div class="row-fluid">
		...
		<div class="span4">
			...
			<div class="btn-group sublet_fields" data-toggle="buttons-radio" data-field-name="air">
				...
				<button type="button" class="btn btn-primary" value="0">No</button>
			</div>
		</div>
	...
	<div class="row-fluid">
		...
		<!-- <div class="pull-left">
			...
			<div class="btn-group sublet_fields" data-toggle="buttons-radio" data-field-name="washer">
				<button type="button" class="btn btn-primary" value="0">None</button>
				<button type="button" class="btn btn-primary" value="1">In-Unit</button>
				<button type="button" class="btn btn-primary" value="2">On-Site</button>
				<button type="button" class="btn btn-primary" value="3">Off-Site</button>
			</div>
		</div> -->
		...
		<div class="pull-left">
			...
			<div class="btn-group sublet_fields" data-toggle="buttons-radio" data-field-name="furnished">
				<button type="button" class="btn btn-primary" value="2">Fully</button>
				<button type="button" class="btn btn-primary" value="1">Partially</button>
				<button type="button" class="btn btn-primary" value="0">No</button>
			</div>
		</div>
