...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<font color="#000000" face="arial, helvetica neue, helvetica, sans-serif">Cribspot Tour Confirmation</font></h3>
<br>
...
<div>
	...
	foreach ($tour_data as $tour){ ?>
		<span style="font-family: arial, 'helvetica neue', helvetica, sans-serif; font-size: 14px;"><strong><?= $tour['time']; ?></strong></span><br>
	<?php
	}
	?>
</div>
<div style="font-family: arial, sans-serif; font-size: 13px;">
	<br>
	<span style="font-family: arial, 'helvetica neue', helvetica, sans-serif; font-size: 14px;">If you have any questions about your upcoming tour, let us know!<br>
	<br>
	Thanks,</span><br>
	&nbsp;<br>
	<img align="none" height="27" src="https://gallery.mailchimp.com/891f23f7d9abb3d02a5ab7558/images/cribspot_team.png" style="width: 180px;height: 27px;border: 0;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;" width="180"></div>
