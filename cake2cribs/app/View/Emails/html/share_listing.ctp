...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td class="mcnTextContent" valign="top" style="padding: 0px 9px;text-align: center;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #606060;font-family: Helvetica;font-size: 12px;line-height: 125%;" width="168">
                <h2><?=$listing_name?></h2>
            </td>
        </tr>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial;font-size: 14px;padding: 12px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;padding: 5px;">
                                <a class="mcnButton" title="Check out Cribspot" href='https://www.cribspot.com/listing/<?=$listing?>' target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;word-wrap: break-word;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">Go To Listing</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
