...
<div class="float" id="search-div">
	...
	<div class="fb-facepile" data-href="http://facebook.com/Cribspot" data-action="Comma separated list of action of action types" data-width="300" data-max-rows="1"></div>
</div>
