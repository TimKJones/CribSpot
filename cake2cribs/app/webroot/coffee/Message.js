...
(function() {
  ...
  A2Cribs.Messages = (function() {
    ...
    Messages.setParticipantInfoUI = function(participant) {
      ...
      return A2Cribs.VerifyManager.getVerifyFor(participant.then(function(verification_info) {
        if (verification_info.verified_fb) {
          return $('#participant_pic_large').attr('src', 'https://graph.facebook.com/#{verification_info.fb_id}/picture?width=480&height=640');
        }
      }));
    };
