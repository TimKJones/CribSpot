  ...
  A2Cribs.ClickBubble = (function() {
    ...
    */
    ...
    ClickBubble.prototype.Open = function(marker, sublet_ids) {
      if (sublet_ids == null) sublet_ids = null;
      if (marker) {
    ...
    */
    ...
    ClickBubble.prototype.SetContent = function(marker, sublet_ids) {
      var content, dataTemplate, div, firstSublet, image, is_favorite, subletId, subletIds, subletOwner, template, _i, _j, _len, _len2, _ref;
