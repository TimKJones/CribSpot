  ...
  A2Cribs.Map = (function() {
    ...
    */
    ...
    Map.LoadBasicDataCallback = function(response) {
      var all_listings, all_markers, is_available, key, listing, listings, marker, value, _i, _j, _k, _l, _len, _len2, _len3, _len4, _results;
    ...
    */
    ...
    Map.ToggleListingVisibility = function(listing_ids, listingsCurrentlyVisible, button) {
      var all_listings, all_markers, listing, listing_id, marker, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _m, _ref, _ref2, _ref3, _ref4, _ref5;
      if (button == null) button = void 0;
      ...
      if (!listingsCurrentlyVisible) {
        ...
        for (_k = 0, _len3 = listing_ids.length; _k < _len3; _k++) {
          ...
          if ((_ref4 = marker.GMarker) != null) _ref4.setVisible(true);
