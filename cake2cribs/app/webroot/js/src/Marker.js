  ...
  A2Cribs.Marker = (function() {
    ...
    */
    ...
    FilterVisibleListings = function(subletIdList) {
      var ac, apt, bathType, beds, end_date, female, grad, house, l, male, max_rent, min_rent, no_security_deposit, other, parking, start_date, students_only, subletId, sublet_end_date, sublet_start_date, undergrad, unitType, utilities, visibleListingIds, _i, _len;
