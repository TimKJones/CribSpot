(function() {
  ...
  A2Cribs.Marker = (function(_super) {
    ...
    Marker.prototype.HasScheduling = function() {
      if (this.scheduling != null) return this.scheduling;
      return false;
    };

    Marker.prototype.Init = function(available, scheduling) {
      var marker_dot;
      this.available = available != null ? available : null;
      this.scheduling = scheduling != null ? scheduling : null;
      if (!(available != null)) {
        marker_dot = "unknown";
      ...
      if ((available || available === null) && scheduling) marker_dot = 'schedule';
