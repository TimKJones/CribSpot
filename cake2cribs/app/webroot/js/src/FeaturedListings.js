  ...
  A2Cribs.FeaturedListings = (function() {
    ...
    FeaturedListings.InitializeSidebar = function(university_id, active_listing_type, basicDataDeferred, basicDataCachedDeferred) {
      ...
      $.when(getFlIdsDeferred, basicDataCachedDeferred).then(function(flIds) {
        var all_listing_ids, id, listing, listingObject, listings, marker, randomIds, rental, sidebar_listing_ids, _i, _j, _k, _l, _len, _len2, _len3, _len4;
    ...
    FeaturedListings.LoadFeaturedPMListings = function() {
      return $.ajax({
        ...
        success: function(data) {
          ...
          console.log(FeaturedListings.FeaturedPMListingIds);
          return $("#featured_pm").click(function() {
            var listing_ids, user_id, _ref, _results;
            _ref = A2Cribs.FeaturedPMIdToListingIdsMap;
            _results = [];
            for (user_id in _ref) {
    ...
    Sidebar = (function() {
      ...
      Sidebar.prototype.getListHtml = function(listings) {
        var beds, data, image, lease_length, list, listing, listing_item, name, primary_image_path, rent, start_date, _i, _j, _len, _len2, _ref;
        list = $("<div />");
        for (_i = 0, _len = listings.length; _i < _len; _i++) {
          listing = listings[_i];
