(function() {
  ...
  A2Cribs.SubletEdit = (function() {
    ...
    SubletEdit.CacheStep2Data = function() {
      ...
      A2Cribs.Cache.SubletEditInProgress.Sublet.flexible_dates = $('#SubletFlexibleDates').val();
      ...
      A2Cribs.Cache.SubletEditInProgress.Sublet.parking = $('#SubletParking').val();
      A2Cribs.Cache.SubletEditInProgress.Sublet.ac = $('#SubletAc').val();
    ...
    */
    ...
    SubletEdit.InitStep3 = function() {
      if (A2Cribs.Cache.SubletData.Housemate.length === 0) return;
      ...
      return $("#HousemateGenderTypeId").val(A2Cribs.Cache.SubletData.Housemate[0].gender_type_id);
    };
