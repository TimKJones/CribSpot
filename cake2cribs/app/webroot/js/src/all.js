...
(function() {
  var LargeBubble, MapActivity, QuickRental, SmallBubble, SubletSave, Tour, _ref,
  ...
  A2Cribs.Landing = (function() {
    ...
    Landing.Init = function(locations) {
      ...
      return $("#school_selector").change(function(event) {
        var university, university_id, _i, _len, _ref2;
  ...
  A2Cribs.VerifyManager = (function() {
    ...
    */
    ...
    VerifyManager.getMutalFriends = function(user) {
      var defered, query, _ref1;
      defered = new $.Deferred();
      if ((((_ref1 = this.me) != null ? _ref1.facebook_id : void 0) != null) && (user.facebook_id != null)) {
  ...
  */
  ...
  Tour = (function() {
    ...
    */
    ...
    Tour.SetupInfoUI = function() {
      ...
      $("body").on("keyup", ".roommate_input", function(event) {
        var re, _ref1;
        if (((_ref1 = $(event.currentTarget.parentElement).find(".roommate_name").val()) != null ? _ref1.length : void 0) !== 0) {
          re = /\S+@\S+\.\S+/;
          if (re.test($(event.currentTarget.parentElement).find(".roommate_email").val())) {
            $(event.currentTarget.parentElement).addClass("completed_roommate");
            return;
    ...
    */
    ...
    Tour.RequestTourTimes = function(listing_id, note, housemates) {
      var key, time, times, _ref1;
      if (note == null) {
        note = "";
      }
      times = [];
      _ref1 = this.selected_timeslots;
      for (key in _ref1) {
        time = _ref1[key];
        if (time.date != null) {
          times.push({
    ...
    Tour.SetCalendar = function(offset_date) {
      ...
      for (_i = 0, _len = timeslots.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          _results1 = [];
          for (i = _j = offset_date, _ref1 = offset_date + this.DATE_RANGE_SIZE - 1; offset_date <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = offset_date <= _ref1 ? ++_j : --_j) {
    ...
    */
    ...
    Tour.SetDates = function(offset_date) {
      var calendar_table_dates_html, date_range_array, date_range_string, i, _i, _ref1;
      if (offset_date == null) {
        offset_date = 0;
      }
      date_range_array = [];
      calendar_table_dates_html = "<td></td>";
      for (i = _i = 0, _ref1 = this.DATE_RANGE_SIZE - 1; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
  ...
  A2Cribs.Order.FeaturedListing = (function() {
    ...
    FeaturedListing.prototype.setupUniPriceTable = function(intialState) {
      var rows, uniPrice, _i, _len, _ref1, _ref2;
      rows = "";
      _ref1 = this.UniData;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        uniPrice = _ref1[_i];
    ...
    FeaturedListing.prototype.rangeSelect = function(dateText) {
      var date, i, selectedDate, _date, _i, _ref1, _ref2;
      if (this.PrevSelectedDate != null) {
        ...
        if (this.PrevSelectedDate > selectedDate) {
          _ref1 = [selectedDate, this.PrevSelectedDate], this.PrevSelectedDate = _ref1[0], selectedDate = _ref1[1];
        }
        this.SelectedDateRange = A2Cribs.UtilityFunctions.getDateRange(this.PrevSelectedDate, selectedDate);
        for (i = _i = _ref2 = this.SelectedDateRange.length - 1; _i >= 0; i = _i += -1) {
    ...
    FeaturedListing.prototype.checkForDateConflicts = function() {
      var conflictNotices, d, dates, day, priceDif, selected_dates, unavailDate, uni, _i, _j, _len, _len1, _ref1, _ref2;
      ...
      if (this.Validate()) {
        ...
        return $.ajax({
          ...
          success: function(response) {
            var _ref1;
            response = JSON.parse(response);
            if (((_ref1 = response.error) != null ? _ref1.message : void 0) != null) {
              return A2Cribs.UIManager.Error(response.error.message);
            } else {
  ...
  A2Cribs.Geocoder = (function() {
    ...
    Geocoder.FindAddress = function(street_address, city, state) {
      ...
      this._geocoder.geocode({
        ...
        var component, location, street_name, street_number, type, zip, _i, _j, _len, _len1, _ref1, _ref2;
        if (status === google.maps.GeocoderStatus.OK && response[0].address_components.length >= 2) {
          _ref1 = response[0].address_components;
          for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
            component = _ref1[_i];
  ...
  A2Cribs.Hotlist = (function() {
    ...
    Hotlist.prototype.setup = function() {
      ...
      return $(document).on("checked_logged_in logged_in", function(event) {
        var logged_in, _ref1;
        logged_in = (_ref1 = A2Cribs.Login) != null ? _ref1.logged_in : void 0;
    ...
    Hotlist.prototype.add = function(friend) {
      var postdata, route, _ref1,
        _this = this;
      if (A2Cribs.Login.logged_in) {
        if (((_ref1 = $('#add-field').data('friend')) != null ? _ref1.facebook_id : void 0) != null) {
