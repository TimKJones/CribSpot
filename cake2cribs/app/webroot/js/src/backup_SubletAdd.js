  ...
  A2Cribs.SubletAdd = (function() {
    ...
    SubletAdd.setupUI = function() {
      ...
      $("#goToStep2").click()(function() {
        if (!$('#formattedAddress').text()) {
          ...
          return A2Cribs.SubletAdd.subletAddStep1();
        }
      });
      ...
      $('#finishSubletAdd').click(function() {
    ...
    SubletAdd.subletAddStep1 = function() {
      ...
      return $.post(url, request_data, function(response) {
        return A2Cribs.SubletAdd.Step1Callback(response);
      });
    };

    SubletAdd.Step1Callback = function(response) {
      var data;
