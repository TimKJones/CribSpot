class A2Cribs.FilterManager
	###
	Sets the current set of visible markers to be those contained in visibleMarkerIds
	TODO: After implementing different markers for different zoom levels, this may need to have more data returned.
	###
	@MinRent = 0
	@MaxRent = 999999
	@MaxSliderRent = 4000
