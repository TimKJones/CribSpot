<html>
	...
	<LINK href="lib.css" title="compact" rel="stylesheet" type="text/css">
	<head>
    <title>UBid</title>
  </head>
  <body onload="init();">
...
<div id="index_container">
	<div class="top_section">
		...
		<div id="welcome_wrap">
			<div class="nav_bar_text">Welcome<span class="nav_bar_text" id="welcome_space"></span><span class="nav_bar_text" id="welcome_msg"></span>!&nbsp<span class="nav_bar_text" id="logout_link">(<a href="#" class="nav_bar_text no_underline" id="auth-logoutlink">logout</a>)</span>	
		...
		<div class="nav_bar_wrap">
			<ul"">
				<li class="top_nav mid"><a href="#" class="no_underline">My UBid</a>&nbsp<img class="prof_pic prof_pic_home" id="prof_pic"/>&nbsp</li>
		...
		<div id="category_bar_wrap">
      	...
      	<li class="menu_item_li"><a class="menu_item"href="#">Subletting</a></li>
				<li class="menu_item_li"><a class="menu_item"href="#">Everything Else</a></li>
